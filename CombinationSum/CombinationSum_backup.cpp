...
* of numbers from the smallest to the next-to largest and giving as target the reminder. If we
* arrive at a reminder of 0 we fill the numbers (starting from the innermost which is the smallest)
